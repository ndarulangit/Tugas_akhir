...
<head>
  ...
  <link rel="icon" href="<?php echo e(asset ('img/brand/pd.png')); ?>" type="image/png">
  ...
  <link href="<?php echo e(asset ('css/nucleo-svg.css')); ?>" rel="stylesheet" />
  <!-- CSS Files -->
  <link href="<?php echo e(asset ('css/argon-design-system.css?v=1.2.2')); ?>" rel="stylesheet" />
</head>
<body>
<section class="section section-lg section-shaped" style="min-height:100vh">
    ...
    <div class="container">
      <div class="row justify-content-between align-items-center">
            ...
            <div id="carousel_example" class="carousel slide" data-ride="carousel">
              ...
              <div class="carousel-inner blur--hover">
                <div class="carousel-item blur-item active">
                  <img class="img-fluid " src="<?php echo e(asset ('img/theme/1.jpg')); ?>" alt="First slide">
                </div>
                <div class="carousel-item blur-item">
                  <img class="img-fluid" src="<?php echo e(asset ('img/theme/2.jpg')); ?>" alt="Second slide">
                </div>
                <div class="carousel-item blur-item">
                  <img class="img-fluid" src="<?php echo e(asset ('img/theme/3.jpg')); ?>" alt="Third slide">
                </div>
        ...
        <div class="col-lg-6 mb-4 mb-lg-2">
          ...
          <a href="<?php echo e(url('/home')); ?>" class="btn btn-secondary mt-2">Mulai</a>
        </div>
      </div>
    </div>
  </div>
  ...
  <script src="<?php echo e(asset ('js/plugins/datetimepicker.js')); ?>" type="text/javascript"></script>
  <script src="<?php echo e(asset ('js/plugins/bootstrap-datepicker.min.js')); ?>"></script>
  <!-- Control Center for Argon UI Kit: parallax effects, scripts for the example pages etc -->
  <!--  Google Maps Plugin    -->
  <script src="https://maps.googleapis.com/maps/api/js?key=YOUR_KEY_HERE"></script>
  <script src="<?php echo e(asset ('js/argon-design-system.min.js')); ?>?v=1.2.2" type="text/javascript"></script>
...
</html><?php /**PATH C:\xampp\htdocs\terakhir_ini_fix\resources\views/landing.blade.php ENDPATH**/ ?>