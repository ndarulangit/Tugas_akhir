...
<nav class="navbar navbar-main navbar-expand-lg bg-primary navbar-dark top-0 shadow py-3">
    <div class="container">
    <a class="navbar-brand mr-lg-3" href="<?php echo e(url('/home')); ?>">
        <img src="<?php echo e(asset ('img/brand/pd.png')); ?>"><span class="ml-3" style="opacity:85%;">Plagiat Detektor</span>
      </a>
    </div>
</nav>
...
</html><?php /**PATH C:\xampp\htdocs\terakhir_ini_fix\resources\views/main.blade.php ENDPATH**/ ?>