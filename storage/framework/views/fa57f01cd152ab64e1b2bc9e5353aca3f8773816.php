...
<nav class="navbar navbar-main navbar-expand-lg bg-primary navbar-dark top-0 shadow py-3">
    <div class="container">
    <a class="navbar-brand mr-lg-3" href="<?php echo e(url('/test')); ?>">
        <img src="<?php echo e(asset ('img/brand/pd.png')); ?>">
      </a>
        <a class="navbar-brand" href="<?php echo e(url('/home')); ?>" style="opacity: 85%;">Plagiat Detektor</a>
